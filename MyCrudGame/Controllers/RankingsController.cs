...
namespace MyCrudGame.Controllers
{
    public class RankingsController : Controller
    {
        ...
        public RankingsController(CRUDMyGameContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Time,Orbs,Stylish,Damage,ItemUsed,RankBonus,PlayerId")] Ranking ranking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Time,Orbs,Stylish,Damage,ItemUsed,RankBonus,PlayerId")] Ranking ranking)
        {
            if (id != ranking.Id)
            {
                return NotFound();
